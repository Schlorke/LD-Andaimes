...
export const metadata: Metadata = {
  ...
  keywords: "andaimes, escoramentos, construção civil, Porto Alegre, locação andaimes, segurança obras",
  ...
  openGraph: {
    ...
    description: "Locação e venda de andaimes com segurança e qualidade garantidas. Atendemos Porto Alegre e região.",
  ...
  twitter: {
    ...
    description: "Locação e venda de andaimes com segurança e qualidade garantidas.",
  },
  robots: {
    index: true,
    follow: true,
...
export default function RootLayout({
  ...
  return (
    <html lang="pt-BR" suppressHydrationWarning>
      <body className={`${inter.variable} ${jost.variable} ${jetbrainsMono.variable} font-sans antialiased`}>
