      ...
      <div className="relative z-10 container mx-auto max-w-7xl px-4 py-16">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-r from-orange-500 to-orange-600 shadow-lg">
            ...
            <div className="flex space-x-3">
              <Button
                variant="ghost"
                size="sm"
                className="text-gray-300 transition-all duration-300 hover:scale-105 hover:bg-orange-600/20 hover:text-orange-400"
                asChild
              >
                <a
          ...
          {/* Products */}
          <div>
            <h3 className="font-display mb-6 text-xl font-bold text-orange-400">
              Produtos
            </h3>
            <ul className="space-y-3">
              {footerLinks.produtos.map(link => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="inline-block transform text-gray-300 transition-all duration-300 hover:translate-x-1 hover:text-orange-400"
                  >
                    {link.name}
                  </Link>
                </li>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div className="text-sm">
                  <p className="text-gray-300 transition-colors duration-300 hover:text-orange-400">
                    (51) 3276-3836
                  </p>
                  <p className="text-gray-300 transition-colors duration-300 hover:text-orange-400">
                    (51) 3276-1982
              ...
              <div className="flex items-start space-x-3">
                ...
                <a
                  ...
                  className="text-sm text-gray-300 transition-all duration-300 hover:text-orange-400"
                >
        ...
        <div className="mt-12 flex flex-col items-center justify-between border-t border-gray-700 pt-8 md:flex-row">
          ...
          <div className="mt-4 flex space-x-8 md:mt-0">
            <Link
              href="/privacidade"
              className="text-sm text-gray-400 transition-all duration-300 hover:text-orange-400"
            >
              Privacidade
            </Link>
            <Link
